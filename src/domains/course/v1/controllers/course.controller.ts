...
import { deleteModuleSchema } from '../schemas/module/delete-module.schema';
import { updateModuleSchema } from '../schemas/module/update-module.schema';
...
import { getModuleSchema } from '../schemas/module/get-module.schema';
import { getModulesByCourseSchema } from '../schemas/module/get-module-by-courseId.schema';
...
import { getLessonsByModuleSchema } from '../schemas/lesson/get-lessons-by-module.schema';
...
import { createModuleSchema } from '../schemas/module/create-module.schema';
...
import { COURSE_MESSAGES } from '../utils/response-messages/course-messages';
...
import { CourseResponseMapper } from '../utils/mappers/course.mapper';
...
export class CourseController {
  ...
  async getCourseAnalytics(req: Request, res: Response) {
    ...
    const analytics: CourseAnalytics = {
      ...
      ratingsBreakdown: ratingBreakDown
        ? {
            1: ratingBreakDown['_1'],
            2: ratingBreakDown['_2'],
            3: ratingBreakDown['_3'],
            4: ratingBreakDown['_4'],
            5: ratingBreakDown['_5'],
          }
        : {
            1: 0,
            2: 0,
  ...
  @Trace('CourseController.getModule')
  @MonitorGrpc('CourseService', 'getModule')
  async getModule(req: Request, res: Response) {
    ...
    return new ResponseWrapper(res)
      ...
      .success(
        CourseResponseMapper.toModule(module!),
        COURSE_MESSAGES.SECTION_FETCHED.message
      );
  }

  @Trace('CourseController.createModule')
  @MonitorGrpc('CourseService', 'createModule')
  async createModule(req: Request, res: Response) {
    ...
    const { module } = await this.courseServiceClient.createModule(
      validPayload,
      {
        metadata: attachMetadata(req),
      }
  ...
  @Trace('CourseController.deleteModule')
  @MonitorGrpc('CourseService', 'deleteModule')
  async deleteModule(req: Request, res: Response) {
    ...
    const { success } = await this.courseServiceClient.deleteModule(
      validPayload,
      {
        metadata: attachMetadata(req),
      }
  ...
  @Trace('CourseController.updateModule')
  @MonitorGrpc('CourseService', 'updateModule')
  async updateModule(req: Request, res: Response) {
    ...
    const { module } = await this.courseServiceClient.updateModule(
      validPayload,
      {
        metadata: attachMetadata(req),
      }
  ...
  @Trace('CourseController.getModulesByCourse')
  @MonitorGrpc('CourseService', 'getModulesByCourse')
  async getModulesByCourse(req: Request, res: Response) {
    ...
    const { modules } = await this.courseServiceClient.getModulesByCourse(
      validPayload,
      {
        metadata: attachMetadata(req),
      }
    ...
    return new ResponseWrapper(res)
      ...
      .success(
        { modules: modules?.modules.map(CourseResponseMapper.toModule) },
  ...
  @Trace('CourseController.getLessonsByModule')
  @MonitorGrpc('CourseService', 'getLessonsByModule')
  async getLessonsByModule(req: Request, res: Response) {
    ...
    const { lessons } = await this.courseServiceClient.getLessonsByModule(
      validPayload,
      {
        metadata: attachMetadata(req),
      }
