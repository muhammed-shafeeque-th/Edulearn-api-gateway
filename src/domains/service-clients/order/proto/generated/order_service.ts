...
export const GetRevenueStatsResponse: MessageFns<GetRevenueStatsResponse> = {
  ...
  fromJSON(object: any): GetRevenueStatsResponse {
    return {
      success: isSet(object.success) ? RevenueStatsData.fromJSON(object.success) : undefined,
...
export const RevenueStatsData: MessageFns<RevenueStatsData> = {
  encode(message: RevenueStatsData, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.revenueStats.push(RevenueStats.decode(reader, reader.uint32()));
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  create<I extends Exact<DeepPartial<RevenueStatsData>, I>>(base?: I): RevenueStatsData {
    return RevenueStatsData.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<RevenueStatsData>, I>>(object: I): RevenueStatsData {
    const message = createBaseRevenueStatsData();
    message.revenueStats = object.revenueStats?.map((e) => RevenueStats.fromPartial(e)) || [];
    return message;
  },
};
