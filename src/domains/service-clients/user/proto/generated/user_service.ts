...
export interface UserServiceClient extends Client {
  ...
  registerInstructor(
    ...
    callback: (
      error: ServiceError | null,
      response: RegisterInstructorResponse
    ) => void
  ): ClientUnaryCall;
  registerInstructor(
    request: RegisterInstructorRequest,
  ...
  getInstructorByName(
    ...
    callback: (
      error: ServiceError | null,
      response: GetInstructorByNameResponse
    ) => void
  ): ClientUnaryCall;
  getInstructorByName(
    request: GetInstructorByNameRequest,
  ...
  listInstructors(
    ...
    callback: (
      error: ServiceError | null,
      response: ListInstructorsResponse
    ) => void
  ): ClientUnaryCall;
  listInstructors(
    request: ListInstructorsRequest,
  ...
  unBlockAccount(
    ...
    callback: (
      error: ServiceError | null,
      response: UnBlockAccountResponse
    ) => void
  ): ClientUnaryCall;
  unBlockAccount(
    request: UnBlockAccountRequest,
  ...
  blockInstructor(
    ...
    callback: (
      error: ServiceError | null,
      response: BlockInstructorResponse
    ) => void
  ): ClientUnaryCall;
  blockInstructor(
    request: BlockInstructorRequest,
  ...
  unBlockInstructor(
    ...
    callback: (
      error: ServiceError | null,
      response: UnBlockInstructorResponse
    ) => void
  ): ClientUnaryCall;
  unBlockInstructor(
    request: UnBlockInstructorRequest,
  ...
  isStudentOfInstructor(
    ...
    callback: (
      error: ServiceError | null,
      response: IsStudentOfInstructorResponse
    ) => void
  ): ClientUnaryCall;
  isStudentOfInstructor(
    request: IsStudentOfInstructorRequest,
  ...
  getInstructorsStats(
    ...
    callback: (
      error: ServiceError | null,
      response: GetInstructorsStatsResponse
    ) => void
  ): ClientUnaryCall;
  getInstructorsStats(
    request: Empty,
  ...
  getInstructorsGrowthTrend(
    ...
    callback: (
      error: ServiceError | null,
      response: GetInstructorsGrowthTrendResponse
    ) => void
  ): ClientUnaryCall;
  getInstructorsGrowthTrend(
    request: GetInstructorsGrowthTrendRequest,
  ...
  getUsersGrowthTrend(
    ...
    callback: (
      error: ServiceError | null,
      response: GetUsersGrowthTrendResponse
    ) => void
  ): ClientUnaryCall;
  getUsersGrowthTrend(
    request: GetUsersGrowthTrendRequest,
...
export interface WalletServiceClient extends Client {
  ...
  getInstructorRevenueSummery(
    ...
    callback: (
      error: ServiceError | null,
      response: GetInstructorRevenueSummeryResponse
    ) => void
  ): ClientUnaryCall;
  getInstructorRevenueSummery(
    request: GetInstructorRevenueSummeryRequest,
...
export interface CartServiceClient extends Client {
  ...
  toggleCartItem(
    ...
    callback: (
      error: ServiceError | null,
      response: ToggleCartItemResponse
    ) => void
  ): ClientUnaryCall;
  toggleCartItem(
    request: ToggleCartItemRequest,
...
export interface WishlistServiceClient extends Client {
  ...
  toggleWishlistItem(
    ...
    callback: (
      error: ServiceError | null,
      response: ToggleWishlistItemResponse
    ) => void
  ): ClientUnaryCall;
  toggleWishlistItem(
    request: ToggleWishlistItemRequest,
