...
export const SortOption: MessageFns<SortOption> = {
  ...
  fromPartial<I extends Exact<DeepPartial<SortOption>, I>>(
    object: I
  ): SortOption {
    const message = createBaseSortOption();
...
export const RemoveSuccess: MessageFns<RemoveSuccess> = {
  ...
  create<I extends Exact<DeepPartial<RemoveSuccess>, I>>(
    base?: I
  ): RemoveSuccess {
    return RemoveSuccess.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<RemoveSuccess>, I>>(
    object: I
  ): RemoveSuccess {
    const message = createBaseRemoveSuccess();
