...
export const ClearUserNotificationsRequest: MessageFns<ClearUserNotificationsRequest> = {
  encode(message: ClearUserNotificationsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.userId !== "") {
      writer.uint32(18).string(message.userId);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ClearUserNotificationsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<ClearUserNotificationsRequest>, I>>(base?: I): ClearUserNotificationsRequest {
...
export const NotificationParams: MessageFns<NotificationParams> = {
  encode(message: NotificationParams, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.page !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): NotificationParams {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<NotificationParams>, I>>(base?: I): NotificationParams {
    return NotificationParams.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<NotificationParams>, I>>(object: I): NotificationParams {
    const message = createBaseNotificationParams();
...
export const GetNotificationsRequest: MessageFns<GetNotificationsRequest> = {
  encode(message: GetNotificationsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.params !== undefined) {
      NotificationParams.encode(message.params, writer.uint32(18).fork()).join();
    }
    return writer;
  },
  ...
  fromJSON(object: any): GetNotificationsRequest {
    return {
      userId: isSet(object.userId)
        ...
        ? globalThis.String(object.user_id)
        : "",
      params: isSet(object.params) ? NotificationParams.fromJSON(object.params) : undefined,
    };
  },
...
export const NotificationResponse: MessageFns<NotificationResponse> = {
  encode(message: NotificationResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.success !== undefined) {
      NotificationSuccess.encode(message.success, writer.uint32(10).fork()).join();
    }
  ...
  fromJSON(object: any): NotificationResponse {
    return {
      success: isSet(object.success) ? NotificationSuccess.fromJSON(object.success) : undefined,
...
export const NotificationSuccess: MessageFns<NotificationSuccess> = {
  encode(message: NotificationSuccess, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): NotificationSuccess {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<NotificationSuccess>, I>>(base?: I): NotificationSuccess {
    return NotificationSuccess.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<NotificationSuccess>, I>>(object: I): NotificationSuccess {
    const message = createBaseNotificationSuccess();
...
export const NotificationData: MessageFns<NotificationData> = {
  encode(message: NotificationData, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    globalThis.Object.entries(message.metadata).forEach(([key, value]: [string, string]) => {
      NotificationData_MetadataEntry.encode({ key: key as any, value }, writer.uint32(98).fork()).join();
    });
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 12: {
          ...
          const entry12 = NotificationData_MetadataEntry.decode(reader, reader.uint32());
...
export const NotificationData_MetadataEntry: MessageFns<NotificationData_MetadataEntry> = {
  encode(message: NotificationData_MetadataEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): NotificationData_MetadataEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<NotificationData_MetadataEntry>, I>>(base?: I): NotificationData_MetadataEntry {
    return NotificationData_MetadataEntry.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<NotificationData_MetadataEntry>, I>>(
    object: I,
...
export const GetNotificationResponse: MessageFns<GetNotificationResponse> = {
  encode(message: GetNotificationResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.notification !== undefined) {
      NotificationData.encode(message.notification, writer.uint32(10).fork()).join();
    }
    if (message.error !== undefined) {
      Error.encode(message.error, writer.uint32(18).fork()).join();
    }
...
export const ClearUserNotificationsResponse: MessageFns<ClearUserNotificationsResponse> = {
  encode(message: ClearUserNotificationsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.success !== undefined) {
      DeleteSuccess.encode(message.success, writer.uint32(10).fork()).join();
    }
    if (message.error !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ClearUserNotificationsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<ClearUserNotificationsResponse>, I>>(base?: I): ClearUserNotificationsResponse {
    return ClearUserNotificationsResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ClearUserNotificationsResponse>, I>>(
    object: I,
...
export const GetNotificationsResponse: MessageFns<GetNotificationsResponse> = {
  encode(message: GetNotificationsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.success !== undefined) {
      GetAllNotificationsSuccess.encode(message.success, writer.uint32(10).fork()).join();
    }
    if (message.error !== undefined) {
      Error.encode(message.error, writer.uint32(18).fork()).join();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.success = GetAllNotificationsSuccess.decode(reader, reader.uint32());
          continue;
        }
        case 2: {
          if (tag !== 18) {
  ...
  fromJSON(object: any): GetNotificationsResponse {
    return {
      success: isSet(object.success) ? GetAllNotificationsSuccess.fromJSON(object.success) : undefined,
      error: isSet(object.error) ? Error.fromJSON(object.error) : undefined,
    };
  },
...
export const GetAllNotificationsSuccess: MessageFns<GetAllNotificationsSuccess> = {
  encode(message: GetAllNotificationsSuccess, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetAllNotificationsSuccess {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.notifications.push(NotificationData.decode(reader, reader.uint32()));
          continue;
        }
        case 2: {
          if (tag !== 16) {
  ...
  toJSON(message: GetAllNotificationsSuccess): unknown {
    ...
    if (message.notifications?.length) {
      obj.notifications = message.notifications.map((e) => NotificationData.toJSON(e));
    }
    if (message.total !== 0) {
  ...
  create<I extends Exact<DeepPartial<GetAllNotificationsSuccess>, I>>(base?: I): GetAllNotificationsSuccess {
    return GetAllNotificationsSuccess.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<GetAllNotificationsSuccess>, I>>(object: I): GetAllNotificationsSuccess {
    const message = createBaseGetAllNotificationsSuccess();
    message.notifications = object.notifications?.map((e) => NotificationData.fromPartial(e)) || [];
...
export const NotificationServiceService = {
  sendOtp: {
    ...
    requestSerialize: (value: OTPRequest): Buffer => Buffer.from(OTPRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): OTPRequest => OTPRequest.decode(value),
  ...
  clearUserNotifications: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ClearUserNotificationsRequest): Buffer =>
      Buffer.from(ClearUserNotificationsRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): ClearUserNotificationsRequest => ClearUserNotificationsRequest.decode(value),
    responseSerialize: (value: ClearUserNotificationsResponse): Buffer =>
      Buffer.from(ClearUserNotificationsResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): ClearUserNotificationsResponse =>
  ...
  markAsRead: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: MarkNotificationRequest): Buffer =>
      Buffer.from(MarkNotificationRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): MarkNotificationRequest => MarkNotificationRequest.decode(value),
    responseSerialize: (value: NotificationResponse): Buffer =>
      Buffer.from(NotificationResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): NotificationResponse => NotificationResponse.decode(value),
  },
  markAllAsRead: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: MarkAllNotificationsRequest): Buffer =>
      Buffer.from(MarkAllNotificationsRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): MarkAllNotificationsRequest => MarkAllNotificationsRequest.decode(value),
    responseSerialize: (value: NotificationResponse): Buffer =>
      Buffer.from(NotificationResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): NotificationResponse => NotificationResponse.decode(value),
  },
...
export interface NotificationServiceServer extends UntypedServiceImplementation {
  ...
  clearUserNotifications: handleUnaryCall<ClearUserNotificationsRequest, ClearUserNotificationsResponse>;
...
export interface NotificationServiceClient extends Client {
  ...
  clearUserNotifications(
    ...
    callback: (error: ServiceError | null, response: ClearUserNotificationsResponse) => void,
  ): ClientUnaryCall;
  clearUserNotifications(
    request: ClearUserNotificationsRequest,
    metadata: Metadata,
