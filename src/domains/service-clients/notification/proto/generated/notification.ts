...
export const NotificationServiceService = {
  sendOtp: {
    ...
    requestSerialize: (value: OTPRequest): Buffer =>
    ...
    responseDeserialize: (value: Buffer): NotificationResponse =>
      NotificationResponse.decode(value),
  },
  verifyOtp: {
    path: '/notification.NotificationService/VerifyOTP',
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: VerifyOTPRequest): Buffer =>
      Buffer.from(VerifyOTPRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): VerifyOTPRequest =>
      VerifyOTPRequest.decode(value),
    responseSerialize: (value: NotificationResponse): Buffer =>
      Buffer.from(NotificationResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): NotificationResponse =>
      NotificationResponse.decode(value),
  ...
  clearUserNotifications: {
    ...
    requestDeserialize: (value: Buffer): ClearUserNotificationsRequest =>
  ...
  getNotifications: {
    ...
    requestDeserialize: (value: Buffer): GetNotificationsRequest =>
    ...
    responseDeserialize: (value: Buffer): GetNotificationsResponse =>
  ...
  markAsRead: {
    ...
    requestDeserialize: (value: Buffer): MarkNotificationRequest =>
  ...
  markAllAsRead: {
    ...
    requestDeserialize: (value: Buffer): MarkAllNotificationsRequest =>
