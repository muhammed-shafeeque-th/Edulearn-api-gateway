...
export const GetCoursesByIdsResponse: MessageFns<GetCoursesByIdsResponse> = {
  ...
  fromJSON(object: any): GetCoursesByIdsResponse {
    return {
      success: isSet(object.success) ? CoursesResponse.fromJSON(object.success) : undefined,
...
export const GetAllCoursesRequest: MessageFns<GetAllCoursesRequest> = {
  encode(message: GetAllCoursesRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetAllCoursesRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<GetAllCoursesRequest>, I>>(base?: I): GetAllCoursesRequest {
    return GetAllCoursesRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<GetAllCoursesRequest>, I>>(object: I): GetAllCoursesRequest {
    const message = createBaseGetAllCoursesRequest();
...
export const CourseData: MessageFns<CourseData> = {
  ...
  fromJSON(object: any): CourseData {
    return {
      ...
      title: isSet(object.title) ? globalThis.String(object.title) : undefined,
      topics: globalThis.Array.isArray(object?.topics) ? object.topics.map((e: any) => globalThis.String(e)) : [],
      instructorId: isSet(object.instructorId) ? globalThis.String(object.instructorId) : undefined,
      subTitle: isSet(object.subTitle) ? globalThis.String(object.subTitle) : undefined,
      category: isSet(object.category) ? globalThis.String(object.category) : undefined,
      subCategory: isSet(object.subCategory) ? globalThis.String(object.subCategory) : undefined,
      language: isSet(object.language) ? globalThis.String(object.language) : undefined,
      ...
      enrollments: isSet(object.enrollments) ? globalThis.Number(object.enrollments) : undefined,
...
export const Question: MessageFns<Question> = {
  ...
  fromJSON(object: any): Question {
    return {
      ...
      correctAnswer: isSet(object.correctAnswer) ? globalThis.String(object.correctAnswer) : "",
...
function createBaseReviewData(): ReviewData {
  return { id: "", userId: "", courseId: "", rating: 0, comment: "", createdAt: "", updatedAt: "" };
}
...
export const CourseServiceService = {
  ...
  getAllCourse: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: GetAllCoursesRequest) => Buffer.from(GetAllCoursesRequest.encode(value).finish()),
  ...
  createEnrollment: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: CreateEnrollmentRequest) => Buffer.from(CreateEnrollmentRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => CreateEnrollmentRequest.decode(value),
  ...
  updateProgress: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: UpdateProgressRequest) => Buffer.from(UpdateProgressRequest.encode(value).finish()),
  ...
  getProgressByEnrollment: {
    ...
    responseSerialize: (value: ProgressesResponse) => Buffer.from(ProgressesResponse.encode(value).finish()),
  ...
  createReview: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: CreateReviewRequest) => Buffer.from(CreateReviewRequest.encode(value).finish()),
...
export interface CourseServiceServer extends UntypedServiceImplementation {
  ...
  /** Enrollment CRUD */
  createEnrollment: handleUnaryCall<CreateEnrollmentRequest, EnrollmentResponse>;
  ...
  getProgressByEnrollment: handleUnaryCall<GetProgressByEnrollmentRequest, ProgressesResponse>;
  /** Review CRUD */
...
export interface CourseServiceClient extends Client {
  ...
  getProgressByEnrollment(
    ...
    callback: (error: ServiceError | null, response: ProgressesResponse) => void,
  ): ClientUnaryCall;
  getProgressByEnrollment(
    request: GetProgressByEnrollmentRequest,
    metadata: Metadata,
