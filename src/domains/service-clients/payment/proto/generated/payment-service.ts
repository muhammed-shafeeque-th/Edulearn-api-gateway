...
export const CreatePaymentRequest: MessageFns<CreatePaymentRequest> = {
  ...
  fromJSON(object: any): CreatePaymentRequest {
    return {
      ...
      cancelUrl: isSet(object.cancelUrl) ? globalThis.String(object.cancelUrl) : undefined,
      amount: isSet(object.amount) ? Money.fromJSON(object.amount) : undefined,
      paymentGateway: isSet(object.paymentGateway) ? globalThis.String(object.paymentGateway) : "",
...
export const CapturePaymentSuccess: MessageFns<CapturePaymentSuccess> = {
  encode(message: CapturePaymentSuccess, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    Object.entries(message.metadata).forEach(([key, value]) => {
      CapturePaymentSuccess_MetadataEntry.encode({ key: key as any, value }, writer.uint32(26).fork()).join();
    });
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CapturePaymentSuccess {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3: {
          ...
          const entry3 = CapturePaymentSuccess_MetadataEntry.decode(reader, reader.uint32());
  ...
  create<I extends Exact<DeepPartial<CapturePaymentSuccess>, I>>(base?: I): CapturePaymentSuccess {
    return CapturePaymentSuccess.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CapturePaymentSuccess>, I>>(object: I): CapturePaymentSuccess {
    const message = createBaseCapturePaymentSuccess();
...
export const CapturePaymentSuccess_MetadataEntry: MessageFns<CapturePaymentSuccess_MetadataEntry> = {
  encode(message: CapturePaymentSuccess_MetadataEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CapturePaymentSuccess_MetadataEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<CapturePaymentSuccess_MetadataEntry>, I>>(
    base?: I,
  ): CapturePaymentSuccess_MetadataEntry {
    return CapturePaymentSuccess_MetadataEntry.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CapturePaymentSuccess_MetadataEntry>, I>>(
    object: I,
  ): CapturePaymentSuccess_MetadataEntry {
    const message = createBaseCapturePaymentSuccess_MetadataEntry();
...
function createBaseRazorpayVerifyPaymentRequest(): RazorpayVerifyPaymentRequest {
  return { razorpayPaymentId: "", paymentId: "", razorpayOrderId: "", razorpaySignature: "" };
}

export const RazorpayVerifyPaymentRequest: MessageFns<RazorpayVerifyPaymentRequest> = {
  encode(message: RazorpayVerifyPaymentRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RazorpayVerifyPaymentRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<RazorpayVerifyPaymentRequest>, I>>(base?: I): RazorpayVerifyPaymentRequest {
    return RazorpayVerifyPaymentRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<RazorpayVerifyPaymentRequest>, I>>(object: I): RazorpayVerifyPaymentRequest {
    const message = createBaseRazorpayVerifyPaymentRequest();
...
export const RazorpayVerifyPaymentSuccess: MessageFns<RazorpayVerifyPaymentSuccess> = {
  encode(message: RazorpayVerifyPaymentSuccess, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.paymentId !== "") {
      writer.uint32(42).string(message.paymentId);
    }
    if (message.transactionId !== "") {
    ...
    Object.entries(message.metadata).forEach(([key, value]) => {
      RazorpayVerifyPaymentSuccess_MetadataEntry.encode({ key: key as any, value }, writer.uint32(26).fork()).join();
    });
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): RazorpayVerifyPaymentSuccess {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3: {
          ...
          const entry3 = RazorpayVerifyPaymentSuccess_MetadataEntry.decode(reader, reader.uint32());
          if (entry3.value !== undefined) {
            message.metadata[entry3.key] = entry3.value;
          }
          continue;
  ...
  create<I extends Exact<DeepPartial<RazorpayVerifyPaymentSuccess>, I>>(base?: I): RazorpayVerifyPaymentSuccess {
    return RazorpayVerifyPaymentSuccess.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<RazorpayVerifyPaymentSuccess>, I>>(object: I): RazorpayVerifyPaymentSuccess {
    const message = createBaseRazorpayVerifyPaymentSuccess();
    message.paymentId = object.paymentId ?? "";
    message.transactionId = object.transactionId ?? "";
    message.status = object.status ?? "";
...
export const RazorpayVerifyPaymentSuccess_MetadataEntry: MessageFns<RazorpayVerifyPaymentSuccess_MetadataEntry> = {
  encode(message: RazorpayVerifyPaymentSuccess_MetadataEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.value !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RazorpayVerifyPaymentSuccess_MetadataEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<RazorpayVerifyPaymentSuccess_MetadataEntry>, I>>(
    base?: I,
  ): RazorpayVerifyPaymentSuccess_MetadataEntry {
    return RazorpayVerifyPaymentSuccess_MetadataEntry.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<RazorpayVerifyPaymentSuccess_MetadataEntry>, I>>(
    object: I,
  ): RazorpayVerifyPaymentSuccess_MetadataEntry {
    const message = createBaseRazorpayVerifyPaymentSuccess_MetadataEntry();
    message.key = object.key ?? "";
...
function createBaseStripeCreateSuccess(): StripeCreateSuccess {
  return { paymentId: "", userId: "", orderId: "", clientSecret: "", amount: undefined, status: "", transactionId: "" };
}

export const StripeCreateSuccess: MessageFns<StripeCreateSuccess> = {
  encode(message: StripeCreateSuccess, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.paymentId !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): StripeCreateSuccess {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<StripeCreateSuccess>, I>>(base?: I): StripeCreateSuccess {
    return StripeCreateSuccess.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<StripeCreateSuccess>, I>>(object: I): StripeCreateSuccess {
    const message = createBaseStripeCreateSuccess();
    message.paymentId = object.paymentId ?? "";
    message.userId = object.userId ?? "";
    message.orderId = object.orderId ?? "";
...
function createBaseRazorpayCreateSuccess(): RazorpayCreateSuccess {
  return { paymentId: "", userId: "", orderId: "", providerOrderId: "", amount: undefined, status: "", keyId: "" };
}

export const RazorpayCreateSuccess: MessageFns<RazorpayCreateSuccess> = {
  encode(message: RazorpayCreateSuccess, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.paymentId !== "") {
      writer.uint32(10).string(message.paymentId);
    }
    if (message.userId !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RazorpayCreateSuccess {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<RazorpayCreateSuccess>, I>>(base?: I): RazorpayCreateSuccess {
    return RazorpayCreateSuccess.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<RazorpayCreateSuccess>, I>>(object: I): RazorpayCreateSuccess {
    const message = createBaseRazorpayCreateSuccess();
    message.paymentId = object.paymentId ?? "";
    message.userId = object.userId ?? "";
    message.orderId = object.orderId ?? "";
...
export const PayPalCreateSuccess: MessageFns<PayPalCreateSuccess> = {
  encode(message: PayPalCreateSuccess, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.paymentId !== "") {
      writer.uint32(10).string(message.paymentId);
    }
    if (message.userId !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): PayPalCreateSuccess {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): PayPalCreateSuccess {
    return {
      ...
      amount: isSet(object.amount) ? Money.fromJSON(object.amount) : undefined,
      status: isSet(object.status) ? globalThis.String(object.status) : "",
      approvalUrl: isSet(object.approvalUrl) ? globalThis.String(object.approvalUrl) : "",
    };
  },
  ...
  create<I extends Exact<DeepPartial<PayPalCreateSuccess>, I>>(base?: I): PayPalCreateSuccess {
    return PayPalCreateSuccess.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<PayPalCreateSuccess>, I>>(object: I): PayPalCreateSuccess {
    const message = createBasePayPalCreateSuccess();
    message.paymentId = object.paymentId ?? "";
    message.userId = object.userId ?? "";
    message.orderId = object.orderId ?? "";
...
export const CreatePaymentResponse: MessageFns<CreatePaymentResponse> = {
  ...
  fromJSON(object: any): CreatePaymentResponse {
    return {
      success: isSet(object.success) ? CreatePaymentSuccess.fromJSON(object.success) : undefined,
...
export const CreatePaymentSuccess: MessageFns<CreatePaymentSuccess> = {
  encode(message: CreatePaymentSuccess, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.stripe !== undefined) {
      StripeCreateSuccess.encode(message.stripe, writer.uint32(10).fork()).join();
    }
    if (message.razorpay !== undefined) {
      RazorpayCreateSuccess.encode(message.razorpay, writer.uint32(18).fork()).join();
    }
    if (message.paypal !== undefined) {
      PayPalCreateSuccess.encode(message.paypal, writer.uint32(26).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2: {
          ...
          message.razorpay = RazorpayCreateSuccess.decode(reader, reader.uint32());
          continue;
        }
        case 3: {
          if (tag !== 26) {
  ...
  fromJSON(object: any): CreatePaymentSuccess {
    return {
      stripe: isSet(object.stripe) ? StripeCreateSuccess.fromJSON(object.stripe) : undefined,
      razorpay: isSet(object.razorpay) ? RazorpayCreateSuccess.fromJSON(object.razorpay) : undefined,
      paypal: isSet(object.paypal) ? PayPalCreateSuccess.fromJSON(object.paypal) : undefined,
    };
  },
  ...
  create<I extends Exact<DeepPartial<CreatePaymentSuccess>, I>>(base?: I): CreatePaymentSuccess {
    return CreatePaymentSuccess.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CreatePaymentSuccess>, I>>(object: I): CreatePaymentSuccess {
    const message = createBaseCreatePaymentSuccess();
    message.stripe = (object.stripe !== undefined && object.stripe !== null)
      ? StripeCreateSuccess.fromPartial(object.stripe)
      : undefined;
    message.razorpay = (object.razorpay !== undefined && object.razorpay !== null)
...
function createBaseProcessRefundRequest(): ProcessRefundRequest {
  return { paymentId: "", userId: "", amount: undefined, reason: "", idempotencyKey: "" };
}
...
export const ProcessRefundRequest: MessageFns<ProcessRefundRequest> = {
  ...
  create<I extends Exact<DeepPartial<ProcessRefundRequest>, I>>(base?: I): ProcessRefundRequest {
    return ProcessRefundRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ProcessRefundRequest>, I>>(object: I): ProcessRefundRequest {
    const message = createBaseProcessRefundRequest();
    message.paymentId = object.paymentId ?? "";
    message.userId = object.userId ?? "";
    message.amount = (object.amount !== undefined && object.amount !== null)
...
function createBaseProcessRefundSuccess(): ProcessRefundSuccess {
  return { refundId: "", paymentId: "", userId: "", amount: undefined, status: "", transactionId: "" };
}

export const ProcessRefundSuccess: MessageFns<ProcessRefundSuccess> = {
  encode(message: ProcessRefundSuccess, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.refundId !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ProcessRefundSuccess {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<ProcessRefundSuccess>, I>>(base?: I): ProcessRefundSuccess {
    return ProcessRefundSuccess.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ProcessRefundSuccess>, I>>(object: I): ProcessRefundSuccess {
    const message = createBaseProcessRefundSuccess();
...
export const ProcessRefundResponse: MessageFns<ProcessRefundResponse> = {
  encode(message: ProcessRefundResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.success !== undefined) {
      ProcessRefundSuccess.encode(message.success, writer.uint32(10).fork()).join();
    }
    if (message.error !== undefined) {
      Error.encode(message.error, writer.uint32(18).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ProcessRefundResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.success = ProcessRefundSuccess.decode(reader, reader.uint32());
          continue;
        }
        case 2: {
          if (tag !== 18) {
  ...
  fromJSON(object: any): ProcessRefundResponse {
    return {
      success: isSet(object.success) ? ProcessRefundSuccess.fromJSON(object.success) : undefined,
      error: isSet(object.error) ? Error.fromJSON(object.error) : undefined,
    };
  },
  ...
  create<I extends Exact<DeepPartial<ProcessRefundResponse>, I>>(base?: I): ProcessRefundResponse {
    return ProcessRefundResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ProcessRefundResponse>, I>>(object: I): ProcessRefundResponse {
    const message = createBaseProcessRefundResponse();
    message.success = (object.success !== undefined && object.success !== null)
...
export const CapturePaymentResponse: MessageFns<CapturePaymentResponse> = {
  encode(message: CapturePaymentResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.success !== undefined) {
      CapturePaymentSuccess.encode(message.success, writer.uint32(10).fork()).join();
    }
    if (message.error !== undefined) {
      Error.encode(message.error, writer.uint32(18).fork()).join();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.success = CapturePaymentSuccess.decode(reader, reader.uint32());
          continue;
        }
        case 2: {
          if (tag !== 18) {
  ...
  fromJSON(object: any): CapturePaymentResponse {
    return {
      success: isSet(object.success) ? CapturePaymentSuccess.fromJSON(object.success) : undefined,
      error: isSet(object.error) ? Error.fromJSON(object.error) : undefined,
    };
  },
...
export const RazorpayVerifyResponse: MessageFns<RazorpayVerifyResponse> = {
  encode(message: RazorpayVerifyResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.success !== undefined) {
      RazorpayVerifyPaymentSuccess.encode(message.success, writer.uint32(10).fork()).join();
    }
    if (message.error !== undefined) {
      Error.encode(message.error, writer.uint32(18).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RazorpayVerifyResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.success = RazorpayVerifyPaymentSuccess.decode(reader, reader.uint32());
          continue;
        }
        case 2: {
          if (tag !== 18) {
  ...
  fromJSON(object: any): RazorpayVerifyResponse {
    return {
      success: isSet(object.success) ? RazorpayVerifyPaymentSuccess.fromJSON(object.success) : undefined,
      error: isSet(object.error) ? Error.fromJSON(object.error) : undefined,
    };
  },
  ...
  create<I extends Exact<DeepPartial<RazorpayVerifyResponse>, I>>(base?: I): RazorpayVerifyResponse {
    return RazorpayVerifyResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<RazorpayVerifyResponse>, I>>(object: I): RazorpayVerifyResponse {
    const message = createBaseRazorpayVerifyResponse();
    message.success = (object.success !== undefined && object.success !== null)
...
export const PaymentServiceService = {
  ...
  payPalPaymentCapture: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: CapturePaymentRequest) => Buffer.from(CapturePaymentRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => CapturePaymentRequest.decode(value),
    responseSerialize: (value: CapturePaymentResponse) => Buffer.from(CapturePaymentResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => CapturePaymentResponse.decode(value),
  },
  razorpayVerifyPayment: {
    ...
    requestDeserialize: (value: Buffer) => RazorpayVerifyPaymentRequest.decode(value),
    responseSerialize: (value: RazorpayVerifyResponse) => Buffer.from(RazorpayVerifyResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => RazorpayVerifyResponse.decode(value),
  },
  ...
  processRefund: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ProcessRefundRequest) => Buffer.from(ProcessRefundRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => ProcessRefundRequest.decode(value),
    responseSerialize: (value: ProcessRefundResponse) => Buffer.from(ProcessRefundResponse.encode(value).finish()),
...
export interface PaymentServiceServer extends UntypedServiceImplementation {
  ...
  payPalPaymentCapture: handleUnaryCall<CapturePaymentRequest, CapturePaymentResponse>;
  razorpayVerifyPayment: handleUnaryCall<RazorpayVerifyPaymentRequest, RazorpayVerifyResponse>;
  /** Process a refund for a payment */
...
export interface PaymentServiceClient extends Client {
  ...
  razorpayVerifyPayment(
    ...
    callback: (error: ServiceError | null, response: RazorpayVerifyResponse) => void,
  ): ClientUnaryCall;
  razorpayVerifyPayment(
    request: RazorpayVerifyPaymentRequest,
    metadata: Metadata,
  ...
  processRefund(
    ...
    callback: (error: ServiceError | null, response: ProcessRefundResponse) => void,
  ): ClientUnaryCall;
  processRefund(
    request: ProcessRefundRequest,
    metadata: Metadata,
