...
export const CreateProviderSessionRequest: MessageFns<CreateProviderSessionRequest> =
  {
    ...
    create<I extends Exact<DeepPartial<CreateProviderSessionRequest>, I>>(
      base?: I
    ): CreateProviderSessionRequest {
      return CreateProviderSessionRequest.fromPartial(base ?? ({} as any));
    },
    fromPartial<I extends Exact<DeepPartial<CreateProviderSessionRequest>, I>>(
      object: I
    ): CreateProviderSessionRequest {
      const message = createBaseCreateProviderSessionRequest();
      message.paymentId = object.paymentId ?? '';
...
export const CreateProviderSessionResponse: MessageFns<CreateProviderSessionResponse> =
  {
    ...
    fromJSON(object: any): CreateProviderSessionResponse {
      return {
        success: isSet(object.success)
          ? CreateProviderSessionSuccess.fromJSON(object.success)
          : undefined,
        error: isSet(object.error) ? Error.fromJSON(object.error) : undefined,
      };
    },
    ...
    create<I extends Exact<DeepPartial<CreateProviderSessionResponse>, I>>(
      base?: I
    ): CreateProviderSessionResponse {
...
export const CreateProviderSessionSuccess: MessageFns<CreateProviderSessionSuccess> =
  {
    ...
    create<I extends Exact<DeepPartial<CreateProviderSessionSuccess>, I>>(
      base?: I
    ): CreateProviderSessionSuccess {
      return CreateProviderSessionSuccess.fromPartial(base ?? ({} as any));
    },
    fromPartial<I extends Exact<DeepPartial<CreateProviderSessionSuccess>, I>>(
      object: I
    ): CreateProviderSessionSuccess {
      const message = createBaseCreateProviderSessionSuccess();
      message.paymentId = object.paymentId ?? '';
...
export const ResolvePaymentRequest: MessageFns<ResolvePaymentRequest> = {
  ...
  fromJSON(object: any): ResolvePaymentRequest {
    return {
      ...
      stripe: isSet(object.stripe)
        ? StripeResolveRequest.fromJSON(object.stripe)
        : undefined,
      razorpay: isSet(object.razorpay)
        ? RazorpayResolveRequest.fromJSON(object.razorpay)
        : undefined,
      paypal: isSet(object.paypal)
        ? PayPalResolveRequest.fromJSON(object.paypal)
        : undefined,
    };
  },
  ...
  create<I extends Exact<DeepPartial<ResolvePaymentRequest>, I>>(
    base?: I
  ): ResolvePaymentRequest {
    return ResolvePaymentRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ResolvePaymentRequest>, I>>(
    object: I
  ): ResolvePaymentRequest {
    const message = createBaseResolvePaymentRequest();
    message.provider = object.provider ?? 0;
...
export const ResolvePaymentResponse: MessageFns<ResolvePaymentResponse> = {
  ...
  fromJSON(object: any): ResolvePaymentResponse {
    return {
      success: isSet(object.success)
        ? ResolvePaymentSuccess.fromJSON(object.success)
        : undefined,
      error: isSet(object.error) ? Error.fromJSON(object.error) : undefined,
    };
  },
  ...
  create<I extends Exact<DeepPartial<ResolvePaymentResponse>, I>>(
    base?: I
  ): ResolvePaymentResponse {
    return ResolvePaymentResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ResolvePaymentResponse>, I>>(
    object: I
  ): ResolvePaymentResponse {
    const message = createBaseResolvePaymentResponse();
    message.success =
...
export const ResolvePaymentSuccess: MessageFns<ResolvePaymentSuccess> = {
  ...
  create<I extends Exact<DeepPartial<ResolvePaymentSuccess>, I>>(
    base?: I
  ): ResolvePaymentSuccess {
    return ResolvePaymentSuccess.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ResolvePaymentSuccess>, I>>(
    object: I
  ): ResolvePaymentSuccess {
    const message = createBaseResolvePaymentSuccess();
    message.status = object.status ?? '';
...
export interface PaymentServiceClient extends Client {
  ...
  createProviderSession(
    ...
    callback: (
      error: ServiceError | null,
      response: CreateProviderSessionResponse
    ) => void
  ): ClientUnaryCall;
  createProviderSession(
    request: CreateProviderSessionRequest,
