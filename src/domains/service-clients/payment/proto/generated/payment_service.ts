...
function createBaseCreateProviderSessionRequest(): CreateProviderSessionRequest {
  return { paymentId: "", provider: 0, successUrl: undefined, cancelUrl: undefined };
}
...
export const CreateProviderSessionRequest: MessageFns<CreateProviderSessionRequest> = {
  ...
  fromJSON(object: any): CreateProviderSessionRequest {
    return {
      paymentId: isSet(object.paymentId)
        ? globalThis.String(object.paymentId)
        : isSet(object.payment_id)
  ...
  toJSON(message: CreateProviderSessionRequest): unknown {
    const obj: any = {};
    if (message.paymentId !== "") {
      obj.paymentId = message.paymentId;
    }
  ...
  create<I extends Exact<DeepPartial<CreateProviderSessionRequest>, I>>(base?: I): CreateProviderSessionRequest {
    return CreateProviderSessionRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CreateProviderSessionRequest>, I>>(object: I): CreateProviderSessionRequest {
    const message = createBaseCreateProviderSessionRequest();
    message.paymentId = object.paymentId ?? "";
...
export const CreateProviderSessionResponse: MessageFns<CreateProviderSessionResponse> = {
  ...
  fromJSON(object: any): CreateProviderSessionResponse {
    return {
      success: isSet(object.success) ? CreateProviderSessionSuccess.fromJSON(object.success) : undefined,
      error: isSet(object.error) ? Error.fromJSON(object.error) : undefined,
    };
  },

  toJSON(message: CreateProviderSessionResponse): unknown {
    const obj: any = {};
    if (message.success !== undefined) {
      obj.success = CreateProviderSessionSuccess.toJSON(message.success);
    }
    if (message.error !== undefined) {
      obj.error = Error.toJSON(message.error);
    }
  ...
  create<I extends Exact<DeepPartial<CreateProviderSessionResponse>, I>>(base?: I): CreateProviderSessionResponse {
    return CreateProviderSessionResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CreateProviderSessionResponse>, I>>(
    object: I,
  ): CreateProviderSessionResponse {
    const message = createBaseCreateProviderSessionResponse();
    message.success = (object.success !== undefined && object.success !== null)
      ? CreateProviderSessionSuccess.fromPartial(object.success)
      : undefined;
    message.error = (object.error !== undefined && object.error !== null) ? Error.fromPartial(object.error) : undefined;
    return message;
  },
...
function createBaseCreateProviderSessionSuccess(): CreateProviderSessionSuccess {
  return { paymentId: "", provider: 0, stripe: undefined, razorpay: undefined, paypal: undefined };
}
...
export const CreateProviderSessionSuccess: MessageFns<CreateProviderSessionSuccess> = {
  ...
  fromJSON(object: any): CreateProviderSessionSuccess {
    return {
      paymentId: isSet(object.paymentId)
        ? globalThis.String(object.paymentId)
        : isSet(object.payment_id)
        ...
        : "",
      provider: isSet(object.provider) ? providerFromJSON(object.provider) : 0,
      stripe: isSet(object.stripe) ? StripePaymentSession.fromJSON(object.stripe) : undefined,
      razorpay: isSet(object.razorpay) ? RazorpayPaymentSession.fromJSON(object.razorpay) : undefined,
      paypal: isSet(object.paypal) ? PayPalPaymentSession.fromJSON(object.paypal) : undefined,
    };
  },

  toJSON(message: CreateProviderSessionSuccess): unknown {
    const obj: any = {};
    if (message.paymentId !== "") {
      obj.paymentId = message.paymentId;
    }
  ...
  create<I extends Exact<DeepPartial<CreateProviderSessionSuccess>, I>>(base?: I): CreateProviderSessionSuccess {
    return CreateProviderSessionSuccess.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CreateProviderSessionSuccess>, I>>(object: I): CreateProviderSessionSuccess {
    const message = createBaseCreateProviderSessionSuccess();
    message.paymentId = object.paymentId ?? "";
    message.provider = object.provider ?? 0;
...
function createBaseResolvePaymentRequest(): ResolvePaymentRequest {
  return { provider: 0, stripe: undefined, razorpay: undefined, paypal: undefined };
}
...
export const ResolvePaymentRequest: MessageFns<ResolvePaymentRequest> = {
  ...
  fromJSON(object: any): ResolvePaymentRequest {
    return {
      provider: isSet(object.provider) ? providerFromJSON(object.provider) : 0,
      stripe: isSet(object.stripe) ? StripeResolveRequest.fromJSON(object.stripe) : undefined,
      razorpay: isSet(object.razorpay) ? RazorpayResolveRequest.fromJSON(object.razorpay) : undefined,
      paypal: isSet(object.paypal) ? PayPalResolveRequest.fromJSON(object.paypal) : undefined,
    };
  },

  toJSON(message: ResolvePaymentRequest): unknown {
    const obj: any = {};
    if (message.provider !== 0) {
      obj.provider = providerToJSON(message.provider);
    }
    if (message.stripe !== undefined) {
      obj.stripe = StripeResolveRequest.toJSON(message.stripe);
    }
    if (message.razorpay !== undefined) {
      obj.razorpay = RazorpayResolveRequest.toJSON(message.razorpay);
    }
    if (message.paypal !== undefined) {
      obj.paypal = PayPalResolveRequest.toJSON(message.paypal);
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<ResolvePaymentRequest>, I>>(base?: I): ResolvePaymentRequest {
    return ResolvePaymentRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ResolvePaymentRequest>, I>>(object: I): ResolvePaymentRequest {
    const message = createBaseResolvePaymentRequest();
    message.provider = object.provider ?? 0;
    message.stripe = (object.stripe !== undefined && object.stripe !== null)
      ? StripeResolveRequest.fromPartial(object.stripe)
      : undefined;
    message.razorpay = (object.razorpay !== undefined && object.razorpay !== null)
      ? RazorpayResolveRequest.fromPartial(object.razorpay)
      : undefined;
    message.paypal = (object.paypal !== undefined && object.paypal !== null)
      ? PayPalResolveRequest.fromPartial(object.paypal)
      : undefined;
    return message;
  },
};
...
export const ResolvePaymentResponse: MessageFns<ResolvePaymentResponse> = {
  ...
  fromJSON(object: any): ResolvePaymentResponse {
    return {
      success: isSet(object.success) ? ResolvePaymentSuccess.fromJSON(object.success) : undefined,
      error: isSet(object.error) ? Error.fromJSON(object.error) : undefined,
    };
  },

  toJSON(message: ResolvePaymentResponse): unknown {
    const obj: any = {};
    if (message.success !== undefined) {
      obj.success = ResolvePaymentSuccess.toJSON(message.success);
    }
    if (message.error !== undefined) {
      obj.error = Error.toJSON(message.error);
    }
  ...
  create<I extends Exact<DeepPartial<ResolvePaymentResponse>, I>>(base?: I): ResolvePaymentResponse {
    return ResolvePaymentResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ResolvePaymentResponse>, I>>(object: I): ResolvePaymentResponse {
    const message = createBaseResolvePaymentResponse();
    message.success = (object.success !== undefined && object.success !== null)
      ? ResolvePaymentSuccess.fromPartial(object.success)
      : undefined;
    message.error = (object.error !== undefined && object.error !== null) ? Error.fromPartial(object.error) : undefined;
    return message;
  },
...
export const CancelPaymentResponse: MessageFns<CancelPaymentResponse> = {
  ...
  fromJSON(object: any): CancelPaymentResponse {
    return {
      success: isSet(object.success) ? CancelPaymentSuccess.fromJSON(object.success) : undefined,
      error: isSet(object.error) ? Error.fromJSON(object.error) : undefined,
    };
  },
...
export const GetPaymentResponse: MessageFns<GetPaymentResponse> = {
  ...
  fromJSON(object: any): GetPaymentResponse {
    return {
      success: isSet(object.success) ? PaymentData.fromJSON(object.success) : undefined,
      error: isSet(object.error) ? Error.fromJSON(object.error) : undefined,
    };
  },
...
export const ResolvePaymentSuccess: MessageFns<ResolvePaymentSuccess> = {
  ...
  fromJSON(object: any): ResolvePaymentSuccess {
    return {
      status: isSet(object.status) ? globalThis.String(object.status) : "",
      paymentId: isSet(object.paymentId)
        ? globalThis.String(object.paymentId)
  ...
  toJSON(message: ResolvePaymentSuccess): unknown {
    const obj: any = {};
    if (message.status !== "") {
      obj.status = message.status;
    }
  ...
  create<I extends Exact<DeepPartial<ResolvePaymentSuccess>, I>>(base?: I): ResolvePaymentSuccess {
    return ResolvePaymentSuccess.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ResolvePaymentSuccess>, I>>(object: I): ResolvePaymentSuccess {
    const message = createBaseResolvePaymentSuccess();
    message.status = object.status ?? "";
    message.paymentId = object.paymentId ?? "";
    message.orderId = object.orderId ?? "";
...
export const CancelPaymentSuccess: MessageFns<CancelPaymentSuccess> = {
  ...
  create<I extends Exact<DeepPartial<CancelPaymentSuccess>, I>>(base?: I): CancelPaymentSuccess {
    return CancelPaymentSuccess.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CancelPaymentSuccess>, I>>(object: I): CancelPaymentSuccess {
    const message = createBaseCancelPaymentSuccess();
    message.status = object.status ?? "";
    message.paymentId = object.paymentId ?? "";
    message.providerOrderId = object.providerOrderId ?? "";
...
export const GetPaymentSuccess: MessageFns<GetPaymentSuccess> = {
  ...
  create<I extends Exact<DeepPartial<GetPaymentSuccess>, I>>(base?: I): GetPaymentSuccess {
    return GetPaymentSuccess.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<GetPaymentSuccess>, I>>(object: I): GetPaymentSuccess {
    const message = createBaseGetPaymentSuccess();
    message.paymentId = object.paymentId ?? "";
    message.provider = object.provider ?? 0;
    message.status = object.status ?? "";
...
export const PaymentData: MessageFns<PaymentData> = {
  ...
  fromPartial<I extends Exact<DeepPartial<PaymentData>, I>>(object: I): PaymentData {
    const message = createBasePaymentData();
    message.paymentId = object.paymentId ?? "";
    message.provider = object.provider ?? 0;
    message.status = object.status ?? "";
...
export interface PaymentServiceClient extends Client {
  ...
  createProviderSession(
    ...
    callback: (error: ServiceError | null, response: CreateProviderSessionResponse) => void,
  ): ClientUnaryCall;
  createProviderSession(
    request: CreateProviderSessionRequest,
    metadata: Metadata,
  ...
  resolvePayment(
    ...
    callback: (error: ServiceError | null, response: ResolvePaymentResponse) => void,
  ): ClientUnaryCall;
  resolvePayment(
    request: ResolvePaymentRequest,
    metadata: Metadata,
