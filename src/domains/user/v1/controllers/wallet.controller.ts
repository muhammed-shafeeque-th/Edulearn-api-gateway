...
import { getUserWalletSchema } from '../schemas/wallet/get-user-wallet.schema';
import {
  UserWalletData,
  WalletTransaction as WalletTransactionData,
} from '@/domains/service-clients/user/proto/generated/user/types/user_wallet_types';
import { attachMetadata } from '../utils/wallet/attach-metadata';
import { WALLET_MESSAGES } from '../utils/wallet/wallet-response-message';
import { getWalletTransactionsSchema } from '../schemas/wallet/get-wallet-transaction.schema';
import { UserWallet, WalletTransaction } from '../types/wallet';
import { mapPaginationResponse } from '@/shared/utils/map-pagination';
import { WalletResponseMapper } from '../utils/wallet/wallet.mappers';
