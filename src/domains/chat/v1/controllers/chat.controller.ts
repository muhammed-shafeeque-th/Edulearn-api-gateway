...
export class ChatController {
  ...
  async getStudentChats(req: Request, res: Response) {
    const validPayload = validateSchema(
      {
    ...
    const mappedChats = chatsRes?.chats.map(c => ChatResponseMapper.toChat(c));
  ...
  async getInstructorChats(req: Request, res: Response) {
