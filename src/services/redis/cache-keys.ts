export const RESPONSE_CACHE_KEYS = {
  userService: {
    ...
    listUsers: (query: Record<string, any> = {}) =>
      `userService:listUsers:${JSON.stringify(query)}`,
    getInstructorsStats: () => 'userService:getInstructorsStats',
    searchUsers: (query: string) => `userService:searchUsers:query:${query}`,
    getOnlineUsers: () => 'userService:getOnlineUsers',
    listInstructors: (query: Record<string, any> = {}) =>
      `userService:listInstructors:${JSON.stringify(query)}`,
    getInstructorStats: (instructorId: string) =>
      `userService:getInstructorStats:${instructorId}`,
    getInstructorCoursesStats: (instructorId: string) =>
      `userService:getInstructorCoursesStats:${instructorId}`,
  ...
  courseService: {
    ...
    getCourseSummary: (courseId: string) =>
      `courseService:getCourseSummary:${courseId}`,
    ...
    getTopCourses: (limit: number = 10) =>
      `courseService:getTopCourses:limit:${limit}`,
    ...
    getEnrollmentDetail: (enrollmentId: string) =>
      `courseService:getEnrollmentDetail:${enrollmentId}`,
    ...
    getCourseProgressStats: (courseId: string) =>
      `courseService:getCourseProgressStats:${courseId}`,
    ...
    getLessonsForCourse: (courseId: string) =>
      `courseService:getLessonsForCourse:${courseId}`,
    ...
    getCourseOutline: (courseId: string) =>
      `courseService:getCourseOutline:${courseId}`,
